...
<body class="bg-dark">
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      ...
      <br><center><p>Repost by <a href='IPB CIREBON' title='IPB CIREBON' target='_blank'>IPB CIREBON</a></p></center>
      
      <div class="card-body">
        <form action="" method="post">
          <div class="form-group">
            <label for="exampleInputEmail1">Username</label>
            <input class="form-control" name="user" type="text" aria-describedby="emailHelp" value="user" placeholder="Enter Username">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Password</label>
            <input class="form-control" name="password" type="password" value="user" placeholder="Password">
          </div>
